...
def split_videofile(filename, clip_start, clip_end, num):
    ...
    try:
        ...
        video.write_videofile("./resources/videos/origin/" + filename + "_split_" + str(num) + file_extension, fps=25)
        close_clip(video)
    except IOError as e:
        print(e.strerror)
    finally:
        ...
        for filename in files:
            ...
            while clip_start < duration:
                ...
                if clip_end > duration:
                    clip_end = duration
                split_videofile(filename, clip_start, clip_end, num)
                clip_start = clip_end
                num += 1
...
def complinate_videos():
    ...
    while True:
        ...
        while True:
            ...
            close_clip(video)
            try:
                shutil.move("./resources/videos/origin/" + selected_file, "./resources/videos/complinations/" + selected_file)
